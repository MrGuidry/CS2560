...
/* BuyTickets
 * This method is used to allow the user to choose how many tickets they want to buy
...
/* GetSeatsSold
 * This method goes through the theater and increments a variable whenever
 * a seat is comes across has been sold.
 * Returns: numbers of seats sold.
 */
int getSeatsSold(char theater[ROWS][COLUMNS]){
	int sold = 0;
	for(int r = 0; r < ROWS; r++){
