...
protected:
	...
	Animal(const std::string & n, const std::string & t, const std::string & s) : _name(n), _type(t), _sound(s) {       //using C++ 11 in-class member initalizer 
...
int main(int argc, char ** argv) {
	...
	//How would I call Animal Snap?

	printf("%s\n", d.snap().c_str());		  //Dog Snap
	printf("%s\n", d.Animal::snap().c_str()); //Animal Snap
